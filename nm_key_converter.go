...
import "github.com/sofiworker/gonm/logger"
...
func interfaceToString(v interface{}) (d string) {
	...
	d, ok := v.(string)
	if !ok {
		logger.SErrorf("interfaceToString() failed: %#v", v)
		return
	}
	return
}
...
func interfaceToByte(v interface{}) (d byte) {
	...
	d, ok := v.(byte)
	if !ok {
		logger.SErrorf("interfaceToByte() failed: %#v", v)
		return
	}
	return
}
...
func interfaceToInt32(v interface{}) (d int32) {
	...
	d, ok := v.(int32)
	if !ok {
		logger.SErrorf("interfaceToInt32() failed: %#v", v)
		return
	}
	return
}
...
func interfaceToUint32(v interface{}) (d uint32) {
	...
	d, ok := v.(uint32)
	if !ok {
		logger.SErrorf("interfaceToUint32() failed: %#v", v)
		return
	}
	return
}
...
func interfaceToInt64(v interface{}) (d int64) {
	...
	d, ok := v.(int64)
	if !ok {
		logger.SErrorf("interfaceToInt64() failed: %#v", v)
		return
	}
	return
}
...
func interfaceToUint64(v interface{}) (d uint64) {
	...
	d, ok := v.(uint64)
	if !ok {
		logger.SErrorf("interfaceToUint64() failed: %#v", v)
		return
	}
	return
}
...
func interfaceToBoolean(v interface{}) (d bool) {
	...
	d, ok := v.(bool)
	if !ok {
		logger.SErrorf("interfaceToBoolean() failed: %#v", v)
		return
	}
	return
}
...
func interfaceToArrayByte(v interface{}) (d []byte) {
	...
	d, ok := v.([]byte)
	if !ok {
		logger.SErrorf("interfaceToArrayByte() failed: %#v", v)
		return
	}
	return
}
...
func interfaceToArrayString(v interface{}) (d []string) {
	...
	d, ok := v.([]string)
	if !ok {
		logger.SErrorf("interfaceToArrayString() failed: %#v", v)
		return
	}
	return
}
...
func interfaceToArrayUint32(v interface{}) (d []uint32) {
	...
	d, ok := v.([]uint32)
	if !ok {
		logger.SErrorf("interfaceToArrayUint32() failed: %#v", v)
		return
	}
	return
}
...
func interfaceToArrayArrayByte(v interface{}) (d [][]byte) {
	...
	d, ok := v.([][]byte)
	if !ok {
		logger.SErrorf("interfaceToArrayArrayByte() failed: %#v", v)
		return
	}
	return
}
...
func interfaceToArrayArrayUint32(v interface{}) (d [][]uint32) {
	...
	d, ok := v.([][]uint32)
	if !ok {
		logger.SErrorf("interfaceToArrayArrayUint32() failed: %#v", v)
		return
	}
	return
}
...
func interfaceToDictStringString(v interface{}) (d map[string]string) {
	...
	if !ok {
		logger.SErrorf("interfaceToDictStringString() failed: %#v", v)
		return
	}
	return
}
...
func interfaceToIpv6Addresses(v interface{}) (d ipv6Addresses) {
	...
	if !ok {
		...
		if !ok {
			logger.SErrorf("interfaceToIpv6Addresses() failed: %#v", v)
		}
		return
	}
...
func interfaceToIpv6Routes(v interface{}) (d ipv6Routes) {
	...
	if !ok {
		d, ok = v.(ipv6Routes)
		if !ok {
			logger.SErrorf("interfaceToIpv6Routes() failed: %#v", v)
		}
		return
	}
