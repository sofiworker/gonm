...
//	logger.SInfof("GetProxyMethod", proxyMode)
//	return
//}
//
...
//	logger.SInfof("SetProxyMethod", proxyMode)
...
//	logger.SDebugf("Manager.SetProxy proxyType: %q, host: %q, port: %q", proxyType, host, port)
//
//	if port == "" {
//		port = "0"
//	}
...
//	logger.SDebugf("Manager.SetProxyAuthentication proxyType: %s, host: %s, port: %s, use: %v", proxyType, user, password, enable)
//	childSettings, err := getProxyChildSettings(proxyType)
//	if err != nil {
//		return dbusutil.ToError(err)
//	}
